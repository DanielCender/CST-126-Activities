				...
				<div class="">
					...
					<div class="input-group mb-3">
						<input type="text" id="title" name="title" class="form-control"
							...
							onchange="languageFilter(this.value)" required>
					</div>

					<label for="content">Content</label>
					<div class="input-group mb-3">
						<textarea id="content" name="content" class="form-control"
							onchange="languageFilter(this.value)" required><?php echo $content; ?></textarea>
					</div>
					...
					<button id="submit_btn" class="btn btn-outline-primary"
